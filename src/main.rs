...
fn print_help() {
    println!(
        r#"
Honkers Railway Launcher {APP_VERSION}

Usage:
  honkers-railway-launcher [OPTION...]

Options:
  -h, --help            Show this help message and exit
  --debug               Force debug output in stdout (pass twice for trace)
  ...
  --just-run-game       Same as --run-game, but also launches the game when
                        a patch or a predownload is pending
